...
User.create (user_name: "Heiðdís Birta" ,address: "amsterdam", email: "heidis@gmail.com", password: "123456", description: "I was working in customer service when I decided to change my career and try new things! I chose this course because I have people around me working in that field and I wanted to give it a go!" )
...
User.create (user_name: "Lisa Pourier" ,address: "amsterdam", email: "lisa@gmail.com", password: "123456", description: "I want to learn to code to change my life 😀. I started my career as a Business Analyst and Project Manager ~10yrs ago, currently working in Tech B2B software as Process & Tools Lead. Look forward to moving into a Technical role post-bootcamp." )
User.create (user_name: "Anna Putt" ,address: "london", email: "annap@gmail.com", password: "123456", description: "I am the City Manager of Le Wagon in London. I want to learn to code to develop my technical skills and continue up skilling in my job. Outside of work, I love to cycle, swim, and go to art galleries" )
User.create (user_name: "Loes van Puijenbroek" ,address: "amersfort", email: "loes@gmail.com", password: "123456", description: "I'm switching careers after almost 10 years from legal counsel / attorney to frontend developer. Love running (marathons), music, reading (scifi/fantasy mainly).")
