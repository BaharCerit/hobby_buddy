...
user_18 = User.create(user_name: "Angela López" ,address: "amsterdam", email: "Angela@gmail.com", password: "123456", description: "Hi everyone, I am working at Le Wagon and doing the social media. In my free time, i'm working in freelance orgenising pinp-pong tourments" )
user_19 = User.create(user_name: "Benedetta Francesconi",address: "amsterdam", email: "Benedetta@gmail.com", password: "123456", description: "I'm data scienst teacher in Le Wagon. fun fact abot me: I am italian, and i don't like tomatos" )
user_20 = User.create(user_name: "Benedetta Francesconi",address: "amsterdam", email: "Benedetta@gmail.com", password: "123456", description: "I'm data scienst teacher in Le Wagon. fun fact abot me: I am italian, and i don't like tomatos" )
user_21 = User.create(user_name: "Nui Suriya",address: "amsterdam", email: "Benedetta@gmail.com", password: "123456", description: "Culinary wizard, language sage, and drumming dynamo—our ,extraordinaire who proves that learning is not just about textbooks; it's about embracing the flavors of life and marching to the beat of your own taiko drum. 🍣🥁 Arigatou gozaimasu, sensei!" )
user_22 = User.create(user_name: " Francesca",address: "amsterdam", email: "Francesca@gmail.com", password: "123456", description: "I tread with humble steps, A student of technology, where innovation never rests.With Ruby on Rails as my canvas, I paint with lines of code,Crafting digital symphonies, where possibilities explode.")

[user_1, user_2, user_3, user_4, user_5].each do |user|
